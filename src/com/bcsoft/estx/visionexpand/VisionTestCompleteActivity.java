...
public class VisionTestCompleteActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Button cb3 = new Button(this); cb3.setText("MIDDLE");
		 * 
		 * ///relativeLayout.addView(cb3, rlb3);
        ...
        //getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.expander1_window_title);
